...
def search(request):
    ...
    if request.method == "POST":
        ...
        my_records = Mieszkaniec.objects.filter(nazwa__contains=searched).filter(zgoda__contains="tak") | Mieszkaniec.objects.filter(
            indeks__contains=searched).filter(zgoda__contains="tak") | Mieszkaniec.objects.filter(adres__contains=searched).filter(zgoda__contains="tak") | Mieszkaniec.objects.filter(telefon__contains=searched).filter(zgoda__contains="tak")
