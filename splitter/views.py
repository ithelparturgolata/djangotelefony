    ...
    if request.method == 'POST':
        try:
            ...
            while start_page < num_total_pages:
                ...
                output_file_name = f'{base_name}_{file_counter:03d}.pdf'  # Format with leading zeros
...
#                     pdf_writer.add_page(pdf_reader.pages[page_num])
#
#                 output_file_name = f'{base_name}_{file_counter}.pdf'
#                 output_file_path = os.path.join(output_dir, output_file_name)
#                 with open(output_file_path, 'wb') as output_file:
#                     pdf_writer.write(output_file)
#
...
# #                     pdf_writer.add_page(pdf_reader.pages[page_num])
# #
# #                 output_file_path = os.path.join(output_dir, f'page_{start_page + 1}_to_{end_page}.pdf')
# #                 with open(output_file_path, 'wb') as output_file:
# #                     pdf_writer.write(output_file)
# #
# #                 start_page += num_pages
